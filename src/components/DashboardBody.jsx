  ...
  return (
    <div className="h-[100%] w-[100%]">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
        <div className="px-[40px] md:px-[30px] py-[15px] rounded-[30px] shadow-md shadow-gray-400 bg-[#151515] flex gap-5 items-center justify-between">
          <img
          ...
          />
          <div className="">
            <div className="text-[20px] md:text-[22px] font-bold">$5,001.50</div>
        ...
        <div className="px-[40px] md:px-[30px] py-[15px] rounded-[30px] shadow-md shadow-gray-400 bg-[#151515] flex gap-5 items-center justify-between">
          ...
          />
          <div className="">
            <div className="text-[20px] md:text-[22px] font-bold">$2,001.50</div>
      ...
      <div className="">
        <div className="text-[25px] font-bold mb-[10px]">Recent Transactions</div>
